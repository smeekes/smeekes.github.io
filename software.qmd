...
The R package `bootUR`, co-authored with Ines Wilms, is available on [CRAN](https://cran.r-project.org/package=bootUR) and [GitHub](https://github.com/smeekes/bootUR). In this package we implement several bootstrap unit root tests, both for univariate and multivariate time series, including (but not limited to) all the unit root tests proposed in my papers. For details see the [website](https://stephansmeekes.com/bootUR/) or the accompanying [JSS paper](https://doi.org/10.18637/jss.v106.i12).
...
### Autotune {#sec-Autotune}
##### R package for fast, accurate, and automatic LASSO tuning parameter selection

The R package `Autotune`, developed by Tathagata Sadhukhan, is available on [GitHub](https://github.com/Tathagata-S/Autotune). This package implements the *Autotune* method, as proposed in the paper "Autotune: fast, accurate, and automatic tuning parameter selection for LASSO."

### Transmission Channel Analysis {#sec-TCA}
##### Toolbox for estimating dynamic transmission channels

The [TCA toolbox](https://enweg.github.io/tca-website/) developed by Enrico Wegner allows for estimating transmission channels as proposed in the paper "Transmission Channel Analysis in Dynamic Models." 
There is both a [Julia version](https://github.com/enweg/TransmissionChannelAnalysis.jl) and [Matlab version](https://github.com/enweg/tca-matlab-toolbox) available.

### Individual Codes {#sec-codes}
##### Scripts not available in a package

::: {.callout-note}
The codes are provided without any warranty whatsoever and will not be updated except to fix bugs. All codes are provided under a [GPL 2 or later](https://www.gnu.org/licenses/licenses.html#GPL) license unless stated otherwise. To cite the codes, please cite the relevant papers and provide a link to this website.
:::

----
[Code and data](https://doi.org/10.3886/E205441V1) for replication of the results in the paper "Min(d)ing the President: A text analytic approach to measuring tax news."
